...
const EVENTS = [
  ...
  
  {
    ...
    {
    id: 'duodance', link: 'https://docs.google.com/forms/d/e/1FAIpQLSci-YgFNgLdfCZSjs1_9pHYsOSzns4gd6av9oAf_DQ4w_Osog/viewform?usp=pp_url&entry.35534824=Duo+Dance', name: 'Duo dance', category: 'Dance',
...
'Participation: Duo participation only (2 members per team)',
' Time Limit: Performance duration should not exceed 6 minutes',
' Dance Style: All dance styles are permitted',
'Dress Code: Participants must wear decent and appropriate attire',
'Performance: Maintain coordination, expression, and stage presence',
...
'Decision: Judges’ decision will be final',  
  ...
  },
  {
    ...
    instructions: [
      ...
      'Paper: Drawing sheets will be provided.[A3]',
...
'Using vechile to travel leads to disqualification.',
  ...
  },
  {
    ...
    instructions: [
      '👩‍🎨👨‍🎨 Each team must have 2 members from the same branch',
'⏰ Time limit is 1 hour and must be strictly followed',
'🧺 Participants must bring their own materials',
'🌿♻️ Use of eco-friendly materials is encouraged',
'🚫 Ready-made Rangoli, printed designs, and stencils are strictly prohibited',
'📍 Venue is at the college entrance',
'🟩 Rangoli must be created only within the assigned space',
'🎭 Designs should be unique and creative',
'🧹 Participants must maintain cleanliness during and after the competition',
'❌ Any misconduct or rule violation will lead to disqualification',
'🪔 Candles or diyas can be used with proper safety measures',
'👩‍⚖️ Judges’ decision will be final and binding',
