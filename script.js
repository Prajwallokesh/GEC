...
const EVENT_IMAGES = {
  ...
  'treasurehunt': 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&q=70',
...
const EVENTS = [
  ...
  },
  {
    ...
    instructions: [
      ...
      'Cooking at the venue is strictly not allowed.',
      'Only ready-made / no-fire food items are permitted.',
      'Food should be neatly displayed for sale.',
      'Proper hygiene and cleanliness must be maintained.',
      'The stall area must be cleaned after the event.',
      'The decision of the coordinators and judges will be final.',
    ],
    coordinators: [
